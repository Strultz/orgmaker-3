...
void CreateToolbars(HWND hwndRebar, HWND outHwnd[4]) {
    TBBUTTON tbb1[TOOLBAR_MAIN_BUTTON_COUNT] =
    {
        ...
        {22, IDC_TOGGLEFOLLOW, 0,BTNS_BUTTON, {}, 0, (INT_PTR)"Follow Playhead"},
        {0, 0, 0, BTNS_SEP},
    ...
    TBBUTTON tbb2[TOOLBAR_CHANNEL_BUTTON_COUNT] =
    {
        ...
        {0, IDM_TRACK1X, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel 1X (Alt+1)"},
        {1, IDM_TRACK2X, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel 2X (Alt+2)"},
        {2, IDM_TRACK3X, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel 3X (Alt+3)"},
        {3, IDM_TRACK4X, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel 4X (Alt+4)"},
        {4, IDM_TRACK5X, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel 5X (Alt+5)"},
        {5, IDM_TRACK6X, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel 6X (Alt+6)"},
        {6, IDM_TRACK7X, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel 7X (Alt+7)"},
        {7, IDM_TRACK8X, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel 8X (Alt+8)"},
        {0, 0, 0, BTNS_SEP},
        ...
        {8, IDM_TRACKQX, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel QX (Alt+Q)"},
        {9, IDM_TRACKWX, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel WX (Alt+W)"},
        {10, IDM_TRACKEX, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel EX (Alt+E)"},
        {11, IDM_TRACKRX, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel RX (Alt+R)"},
        {12, IDM_TRACKTX, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel TX (Alt+T)"},
        {13, IDM_TRACKYX, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel YX (Alt+Y)"},
        {14, IDM_TRACKUX, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel UX (Alt+U)"},
        {15, IDM_TRACKIX, TBSTATE_ENABLED,BTNS_BUTTON, {}, 0, (INT_PTR)"Channel IX (Alt+I)"},
    };
...
HWND CreateStatusBar(HWND hwnd) {
    ...
    int swidths[] = { w - 578, w - 466, w - 388, w - 320, w - 150, -1 };
    ...
    SendMessage(hwndStatus, SB_SETTEXT, 1, (LPARAM)"Keyboard Measure: 3");
    SendMessage(hwndStatus, SB_SETTEXT, 2, (LPARAM)"Zoom: 100%");
    SendMessage(hwndStatus, SB_SETTEXT, 3, (LPARAM)"Channel 1");
    SendMessage(hwndStatus, SB_SETTEXT, 4, (LPARAM)"Wait: 125 (120.000 BPM)");
    SendMessage(hwndStatus, SB_SETTEXT, 5, (LPARAM)"Meas 0:0");

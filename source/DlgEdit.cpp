...
static int tvol[MAXTRACK] = {
	...
	IDC_DEFVOL1X, IDC_DEFVOL2X, IDC_DEFVOL3X, IDC_DEFVOL4X,
	IDC_DEFVOL5X, IDC_DEFVOL6X, IDC_DEFVOL7X, IDC_DEFVOL8X,
	IDC_DEFVOL9, IDC_DEFVOL10, IDC_DEFVOL11, IDC_DEFVOL12,
	IDC_DEFVOL13, IDC_DEFVOL14, IDC_DEFVOL15, IDC_DEFVOL16,
	IDC_DEFVOL9X, IDC_DEFVOL10X, IDC_DEFVOL11X, IDC_DEFVOL12X,
	IDC_DEFVOL13X, IDC_DEFVOL14X, IDC_DEFVOL15X, IDC_DEFVOL16X,
};
static int tvol_spin[MAXTRACK] = {
	...
	IDC_DEFVOLSPIN1X, IDC_DEFVOLSPIN2X, IDC_DEFVOLSPIN3X, IDC_DEFVOLSPIN4X,
	IDC_DEFVOLSPIN5X, IDC_DEFVOLSPIN6X, IDC_DEFVOLSPIN7X, IDC_DEFVOLSPIN8X,
	...
	IDC_DEFVOLSPIN9X, IDC_DEFVOLSPIN10X, IDC_DEFVOLSPIN11X, IDC_DEFVOLSPIN12X,
	IDC_DEFVOLSPIN13X, IDC_DEFVOLSPIN14X, IDC_DEFVOLSPIN15X, IDC_DEFVOLSPIN16X,
};
static int tpan[MAXTRACK] = {
	IDC_DEFPAN1, IDC_DEFPAN2, IDC_DEFPAN3, IDC_DEFPAN4,
	IDC_DEFPAN5, IDC_DEFPAN6, IDC_DEFPAN7, IDC_DEFPAN8,
	IDC_DEFPAN1X, IDC_DEFPAN2X, IDC_DEFPAN3X, IDC_DEFPAN4X,
	IDC_DEFPAN5X, IDC_DEFPAN6X, IDC_DEFPAN7X, IDC_DEFPAN8X,
	IDC_DEFPAN9, IDC_DEFPAN10, IDC_DEFPAN11, IDC_DEFPAN12,
	IDC_DEFPAN13, IDC_DEFPAN14, IDC_DEFPAN15, IDC_DEFPAN16,
	IDC_DEFPAN9X, IDC_DEFPAN10X, IDC_DEFPAN11X, IDC_DEFPAN12X,
	IDC_DEFPAN13X, IDC_DEFPAN14X, IDC_DEFPAN15X, IDC_DEFPAN16X,
};
static int tpan_spin[MAXTRACK] = {
	...
	IDC_DEFPANSPIN1X, IDC_DEFPANSPIN2X, IDC_DEFPANSPIN3X, IDC_DEFPANSPIN4X,
	IDC_DEFPANSPIN5X, IDC_DEFPANSPIN6X, IDC_DEFPANSPIN7X, IDC_DEFPANSPIN8X,
	...
	IDC_DEFPANSPIN9X, IDC_DEFPANSPIN10X, IDC_DEFPANSPIN11X, IDC_DEFPANSPIN12X,
	IDC_DEFPANSPIN13X, IDC_DEFPANSPIN14X, IDC_DEFPANSPIN15X, IDC_DEFPANSPIN16X,
};
	...
	case WM_NOTIFY: {
		...
		case UDN_DELTAPOS: {
			...
			if (buddy) {
				...
				case IDC_DEFPANSPIN1X:
				case IDC_DEFPANSPIN2X:
				case IDC_DEFPANSPIN3X:
				case IDC_DEFPANSPIN4X:
				case IDC_DEFPANSPIN5X:
				case IDC_DEFPANSPIN6X:
				case IDC_DEFPANSPIN7X:
				case IDC_DEFPANSPIN8X:
				...
				case IDC_DEFPANSPIN9X:
				case IDC_DEFPANSPIN10X:
				case IDC_DEFPANSPIN11X:
				case IDC_DEFPANSPIN12X:
				case IDC_DEFPANSPIN13X:
				case IDC_DEFPANSPIN14X:
				case IDC_DEFPANSPIN15X:
				case IDC_DEFPANSPIN16X:
					v += lud->iDelta;
					if (v < 0) v = 0;
					if (v > 12) v = 12;
					break;
